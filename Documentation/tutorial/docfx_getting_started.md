...
As a prerequisite, you will need [Microsoft .NET Framework 4.6.2 Preview](https://www.microsoft.com/en-us/download/details.aspx?id=51625), [Microsoft .NET Framework 4.6.2 Preview Developer Pack](https://www.microsoft.com/en-us/download/confirmation.aspx?id=51622) and [Latest .NET Command Line Interface](https://github.com/dotnet/cli) to run `build.cmd`
