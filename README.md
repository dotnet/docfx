...
To access docfx 3 preview, install the `docfx` [global tool](https://docs.microsoft.com/en-us/dotnet/core/tools/global-tools) using the latest version of [.NET Core](https://www.microsoft.com/net/download):
