...
Follow the steps in [How to enable custom HTML tag rules](#create-a-custom-html-tag-rule) to configure the plugin and run `docfx` in the project folder. You'll see your rule picked up by the build.
