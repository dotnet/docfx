...
namespace Microsoft.DocAsCode.Dfm.Tests
{
    ...
    public class TestDfmJsonTokenTreeRender
    {
        [Theory]
        [Trait("Related", "DfmMarkdown")]
        [InlineData("", "{\"name\":\"0>0>markdown\",\"children\":[]}")]
        [InlineData("<address@example.com>", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Paragraph\",\"children\":[{\"name\":\"1>1>Link\",\"children\":[{\"name\":\"1>1>Raw(FromInline.AutoLink)>address@example.com\"}]}]}]}")]
        [InlineData(" https://github.com/dotnet/docfx/releases ", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Paragraph\",\"children\":[{\"name\":\"1>1>Text> \"},{\"name\":\"1>1>Link\",\"children\":[{\"name\":\"1>1>Raw(FromInline.Gfm.Url)>https://github.com/dotnet/docfx/releases\"}]},{\"name\":\"1>1>Text> \"}]}]}")]
        [InlineData("<Insert OneGet Details - meeting on 10/30 for details.>", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Html\",\"children\":[{\"name\":\"1>1>Tag\"}]}]}")]
        [InlineData("<http://example.com/>", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Paragraph\",\"children\":[{\"name\":\"1>1>Link\",\"children\":[{\"name\":\"1>1>Raw(FromInline.AutoLink)>http://example.com/\"}]}]}]}")]
        [InlineData("# Hello World", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Heading1\",\"children\":[{\"name\":\"1>1>Text>Hello World\"}]}]}")]
        [InlineData("Hot keys: <kbd>Ctrl+[</kbd> and <kbd>Ctrl+]</kbd>", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Paragraph\",\"children\":[{\"name\":\"1>1>Text>Hot keys\"},{\"name\":\"1>1>Text>: \"},{\"name\":\"1>1>Tag\"},{\"name\":\"1>1>Text>Ctrl+\"},{\"name\":\"1>1>Text>[\"},{\"name\":\"1>1>Tag\"},{\"name\":\"1>1>Text> and \"},{\"name\":\"1>1>Tag\"},{\"name\":\"1>1>Text>Ctrl+]\"},{\"name\":\"1>1>Tag\"}]}]}")]
        [InlineData("<div>Some text here</div>", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Html\",\"children\":[{\"name\":\"1>1>Tag\"},{\"name\":\"1>1>Text>Some text here\"},{\"name\":\"1>1>Tag\"}]}]}")]
        [InlineData(@"---
a: b
b:
  c: e
...
-------------------------------------", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>2>ul\",\"children\":[{\"name\":\"1>1>ListItem\",\"children\":[{\"name\":\"1>1>NonParagraph\",\"children\":[{\"name\":\"1>1>Text>Unordered list item 1\"}]}]},{\"name\":\"2>2>ListItem\",\"children\":[{\"name\":\"2>2>NonParagraph\",\"children\":[{\"name\":\"2>2>Text>Unordered list item 2\"}]}]}]},{\"name\":\"3>4>Heading2\",\"children\":[{\"name\":\"3>3>Text>1. This Is Heading, Not Ordered List\"}]}]}")]
        ...
        [InlineData("@1abc", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Paragraph\",\"children\":[{\"name\":\"1>1>Text>@1abc\"}]}]}")]
        ...
        [InlineData("[name](xref:uid \"title\")", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Paragraph\",\"children\":[{\"name\":\"1>1>Link\",\"children\":[{\"name\":\"1>1>Text>name\"}]}]}]}")]
        [InlineData("<xref:uid>text", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Paragraph\",\"children\":[{\"name\":\"1>1>Xref>uid\",\"children\":[]},{\"name\":\"1>1>Text>text\"}]}]}")]
        [InlineData("<xref:'uid with space'>text", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Paragraph\",\"children\":[{\"name\":\"1>1>Xref>uid with space\",\"children\":[]},{\"name\":\"1>1>Text>text\"}]}]}")]
        [InlineData(
            "[*a*](xref:uid)",
        ...
        {
            TestJsonTokenTreeJsonRender(source, expected);
        }
...
> [!Video https://sec.ch9.ms/ch9/4393/7d7c7df7-3f15-4a65-a2f7-3e4d0bea4393/Episode208_mid.mp4]";
            ...
            TestJsonTokenTreeJsonRender(root, expected);
        }
...
---
hello world";
            var expected = "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Heading1\",\"children\":[{\"name\":\"1>1>Text>Title\"}]},{\"name\":\"2>2>Hr\"},{\"name\":\"3>4>Heading2\",\"children\":[{\"name\":\"3>3>Text>Not yaml syntax\"}]},{\"name\":\"5>5>Paragraph\",\"children\":[{\"name\":\"5>5>Text>hello world\"}]}]}";
...
this is also warning";
            var expected = "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Heading1\",\"children\":[{\"name\":\"1>1>Text>Note not in one line\"}]},{\"name\":\"2>5>Blockquote\",\"children\":[{\"name\":\"2>2>NOTE\"},{\"name\":\"2>3>Paragraph\",\"children\":[{\"name\":\"2>3>Text>hello\\nworld\"}]},{\"name\":\"4>4>WARNING\"},{\"name\":\"4>5>Paragraph\",\"children\":[{\"name\":\"4>5>Text>Hello world\\nthis is also warning\"}]}]}]}";
...
> We should support that.", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>2>Blockquote\",\"children\":[{\"name\":\"1>1>Section\"},{\"name\":\"1>2>Paragraph\",\"children\":[{\"name\":\"1>2>Text>Followed text\\nWe should support that.\"}]}]}]}")]
...
> > this is A
> > [!div class=""B"" id=""B""]
> > this is B", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>6>Blockquote\",\"children\":[{\"name\":\"1>1>Section\"},{\"name\":\"2>2>Paragraph\",\"children\":[{\"name\":\"2>2>Text>this is out all\"}]},{\"name\":\"3>6>Blockquote\",\"children\":[{\"name\":\"3>3>Section\"},{\"name\":\"4>4>Paragraph\",\"children\":[{\"name\":\"4>4>Text>this is A\"}]},{\"name\":\"5>5>Section\"},{\"name\":\"6>6>Paragraph\",\"children\":[{\"name\":\"6>6>Text>this is B\"}]}]}]}]}")]
...
> This is imoprtant text follow div", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>14>Blockquote\",\"children\":[{\"name\":\"1>1>Paragraph\",\"children\":[{\"name\":\"1>1>Text>this is blockquote\"}]},{\"name\":\"3>3>Paragraph\",\"children\":[{\"name\":\"3>3>Text>this line is also in the before blockquote\"}]},{\"name\":\"4>4>NOTE\"},{\"name\":\"5>5>Paragraph\",\"children\":[{\"name\":\"5>5>Text>This is note text\"}]},{\"name\":\"6>6>WARNING\"},{\"name\":\"7>7>Paragraph\",\"children\":[{\"name\":\"7>7>Text>This is warning text\"}]},{\"name\":\"8>8>Section\"},{\"name\":\"9>10>Paragraph\",\"children\":[{\"name\":\"9>10>Text>this is div with class a and id diva\\ntext also in div\"}]},{\"name\":\"11>11>Section\"},{\"name\":\"12>12>Paragraph\",\"children\":[{\"name\":\"12>12>Text>this is div with class b and cause divb\"}]},{\"name\":\"13>13>IMPORTANT\"},{\"name\":\"14>14>Paragraph\",\"children\":[{\"name\":\"14>14>Text>This is imoprtant text follow div\"}]}]}]}")]
        ...
        [Theory]
        [Trait("Related", "DfmMarkdown")]
        [InlineData(@"> [!div]", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Blockquote\",\"children\":[{\"name\":\"1>1>Section\"}]}]}")]
        [InlineData(@"> [!div `id=""error""]", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Blockquote\",\"children\":[{\"name\":\"1>1>Section\"}]}]}")]
        [InlineData(@"> [!div `id=""right""`]", "{\"name\":\"0>0>markdown\",\"children\":[{\"name\":\"1>1>Blockquote\",\"children\":[{\"name\":\"1>1>Section\"}]}]}")]
...
tag started with alphabet should not be encode: <abc> <a-hello> <a?world> <a_b href=""good""> <AC att='bcd'>";
        ...
        [Fact]
        [Trait("Related", "DfmMarkdown")]
        public void TestDfmFencesLevel()
        {
            var source = @"[!code-FakeREST[REST](api.json)]
...
[!code-js[empty](api.json)]";
        ...
        private void TestJsonTokenTreeJsonRender(string source, string expected)
        {
