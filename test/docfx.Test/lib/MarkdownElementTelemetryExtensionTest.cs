    ...
    public static class MarkdownElementTelemetryExtensionTest
    {
        ...
        public static IEnumerable<object[]> ElementTypeTestData =>
            new List<object[]>
            {
                ...
                new object[] { new TripleColonBlock (null) { Extension = new ImageExtensionBlock (null) }, "TripleColonImageBlock" },
                new object[] { new TripleColonInline (null) { Extension = new ImageExtensionInline (null) }, "TripleColonImageInline" },
