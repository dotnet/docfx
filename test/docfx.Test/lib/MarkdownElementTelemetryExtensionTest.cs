    ...
    public static class MarkdownElementTelemetryExtensionTest
    {
        ...
        public static IEnumerable<object[]> ElementTypeTestData =>
            new List<object[]>
            {
                ...
                new object[] { new TabGroupBlock(null, new List<TabItemBlock>() { new TabItemBlock("Fake", "Fake", new TabTitleBlock(), new TabContentBlock(new List<Block>(), null), false) }.ToImmutableArray(), 0, 0, 0), "TabbedContent" },
