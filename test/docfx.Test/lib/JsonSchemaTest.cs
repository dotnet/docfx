...
namespace Microsoft.Docs.Build
{
    public class JsonSchemaTest
    {
        ...
        [InlineData("{'type': 'boolean'}", "'string'",
            "{'message_severity':'warning','log_item_type':'user','code':'unexpected-type','message':'Expected type 'Boolean' but got 'String'.','file':'file','line':1,'end_line':1,'column':8,'end_column':8}")]
        [InlineData("{'type': 'object'}", "1",
            "{'message_severity':'warning','log_item_type':'user','code':'unexpected-type','message':'Expected type 'Object' but got 'Integer'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        [InlineData("{'type': 'string'}", "1",
            "{'message_severity':'warning','log_item_type':'user','code':'unexpected-type','message':'Expected type 'String' but got 'Integer'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]

        // union type validation
        [InlineData("{'type': ['string', 'null']}", "'a'", "")]
        [InlineData("{'properties': {'a': {'type': ['string', 'null']}}}", "{'a': null}", "")]
        [InlineData("{'type': ['string', 'null']}", "1",
            "{'message_severity':'warning','log_item_type':'user','code':'unexpected-type','message':'Expected type 'String, Null' but got 'Integer'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]

        // const validation
        [InlineData("{'const': 1}", "1", "")]
        [InlineData("{'const': 'string'}", "'unknown'",
            "{'message_severity':'warning','log_item_type':'user','code':'invalid-value','message':'Invalid value for '': 'unknown'.','file':'file','line':1,'end_line':1,'column':9,'end_column':9}")]
        [InlineData("{'const': {'a': 1}}", "{}",
            "{'message_severity':'warning','log_item_type':'user','code':'invalid-value','message':'Invalid value for '': '{}'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        ...
        [InlineData("{'type': 'number', 'enum': [1, 2]}", "3",
            "{'message_severity':'warning','log_item_type':'user','code':'invalid-value','message':'Invalid value for '': '3'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]

        // pattern validation
        [InlineData("{'pattern': '^a.*'}", "'a'", "")]
        [InlineData("{'pattern': '^a.*'}", "'b'",
            "{'message_severity':'warning','log_item_type':'user','code':'format-invalid','message':'String 'b' is not a valid '^a.*'.','file':'file','line':1,'end_line':1,'column':3,'end_column':3}")]
        ...
        [InlineData("{'minimum': 100, 'maximum': -100}", "1",
            @"{'message_severity':'warning','log_item_type':'user','code':'number-invalid','message':'Number '1' should be <= -100.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}
              {'message_severity':'warning','log_item_type':'user','code':'number-invalid','message':'Number '1' should be >= 100.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        ...
        [InlineData("{'multipleOf': 2}", "1",
            "{'message_severity':'warning','log_item_type':'user','code':'number-invalid','message':'Number '1' should be multiple of 2.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        ...
        [InlineData("{'type': ['string'], 'format': 'date-time'}", "'invalid'",
            "{'message_severity':'warning','log_item_type':'user','code':'format-invalid','message':'String 'invalid' is not a valid 'DateTime'.','file':'file','line':1,'end_line':1,'column':9,'end_column':9}")]

        [InlineData("{'type': ['string'], 'format': 'date'}", "'1963-06-19'", "")]
        [InlineData("{'type': ['string'], 'format': 'date'}", "'1963-13-99'",
            "{'message_severity':'warning','log_item_type':'user','code':'format-invalid','message':'String '1963-13-99' is not a valid 'Date'.','file':'file','line':1,'end_line':1,'column':12,'end_column':12}")]
        [InlineData("{'type': ['string'], 'format': 'date'}", "'1963-06-19T08:30:06Z'",
            "{'message_severity':'warning','log_item_type':'user','code':'format-invalid','message':'String '1963-06-19T08:30:06Z' is not a valid 'Date'.','file':'file','line':1,'end_line':1,'column':22,'end_column':22}")]

        [InlineData("{'type': ['string'], 'format': 'time'}", "'08:30:06Z'", "")]
        [InlineData("{'type': ['string'], 'format': 'time'}", "'1963-06-19T08:30:06Z'",
            "{'message_severity':'warning','log_item_type':'user','code':'format-invalid','message':'String '1963-06-19T08:30:06Z' is not a valid 'Time'.','file':'file','line':1,'end_line':1,'column':22,'end_column':22}")]

        // properties validation
        [InlineData("{'properties': {'key': {'type': 'string'}}}", "{'key': 'value'}", "")]
        [InlineData("{'properties': {'key': {'type': 'string'}}}", "{'key': 1}",
            "{'message_severity':'warning','log_item_type':'user','code':'unexpected-type','message':'Expected type 'String' but got 'Integer'.','file':'file','line':1,'end_line':1,'column':9,'end_column':9}")]
        ...
        [InlineData("{'properties': {'key': {'type': 'string'}}, 'additionalProperties': false}", "{'key': 'value', 'key1': 'value1'}",
            "{'message_severity':'warning','log_item_type':'user','code':'unknown-field','message':'Could not find member 'key1' on object of type 'String'.','file':'file','line':1,'end_line':1,'column':33,'end_column':33}")]
        [InlineData("{'properties': {'key': {'type': 'string'}}, 'additionalProperties': {'type': 'number'}}", "{'key': 'value', 'key1': 'value1'}",
            "{'message_severity':'warning','log_item_type':'user','code':'unexpected-type','message':'Expected type 'Number' but got 'String'.','file':'file','line':1,'end_line':1,'column':33,'end_column':33}")]
        [InlineData("{'properties': {'key': {'type': 'string'}}, 'additionalProperties': {'type': 'string', 'enum': ['a']}}", "{'key': 'value', 'key1': 'value1'}",
            "{'message_severity':'warning','log_item_type':'user','code':'invalid-value','message':'Invalid value for '': 'value1'.','file':'file','line':1,'end_line':1,'column':33,'end_column':33}")]
        ...
        [InlineData("{'maxProperties': 0}", "{'key': 0}",
            "{'message_severity':'warning','log_item_type':'user','code':'property-count-invalid','message':'Object '' property count should be <= 0.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        [InlineData("{'minProperties': 1}", "{}",
            "{'message_severity':'warning','log_item_type':'user','code':'property-count-invalid','message':'Object '' property count should be >= 1.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        [InlineData("{'maxProperties': 0, 'minProperties': 4}", "{'key': 0}",
            @"{'message_severity':'warning','log_item_type':'user','code':'property-count-invalid','message':'Object '' property count should be <= 0.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}
              {'message_severity':'warning','log_item_type':'user','code':'property-count-invalid','message':'Object '' property count should be >= 4.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]

        // array validation
        [InlineData("{'items': {'type': 'string'}}", "['a','b']", "")]
        [InlineData("{'items': {'type': 'boolean'}}", "['a','b']",
            @"{'message_severity':'warning','log_item_type':'user','code':'unexpected-type','message':'Expected type 'Boolean' but got 'String'.','file':'file','line':1,'end_line':1,'column':4,'end_column':4}
              {'message_severity':'warning','log_item_type':'user','code':'unexpected-type','message':'Expected type 'Boolean' but got 'String'.','file':'file','line':1,'end_line':1,'column':8,'end_column':8}")]

        [InlineData("{'maxItems': 3, 'minItems': 1}", "['a','b']", "")]
        [InlineData("{'properties': {'arr': {'maxItems': 3, 'minItems': 1}}}", "{'arr': ['a','b','c','d']}",
            "{'message_severity':'warning','log_item_type':'user','code':'array-length-invalid','message':'Array 'arr' length should be <= 3.','file':'file','line':1,'end_line':1,'column':9,'end_column':9}")]
        [InlineData("{'maxItems': 3, 'minItems': 1}", "[]",
            "{'message_severity':'warning','log_item_type':'user','code':'array-length-invalid','message':'Array '' length should be >= 1.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        [InlineData("{'maxItems': 2, 'minItems': 4}", "['a','b','c']",
            @"{'message_severity':'warning','log_item_type':'user','code':'array-length-invalid','message':'Array '' length should be <= 2.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}
              {'message_severity':'warning','log_item_type':'user','code':'array-length-invalid','message':'Array '' length should be >= 4.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]

        // uniqueItems validation
        [InlineData("{'uniqueItems': true}", "[1, 2]", "")]
        [InlineData("{'uniqueItems': true}", "[1, 1]",
            @"{'message_severity':'warning','log_item_type':'user','code':'array-not-unique','message':'Array '' items should be unique.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]

        // contains validation
        [InlineData("{'contains': {'const': 1}}", "[1]", "")]
        [InlineData("{'contains': {'const': 1}}", "[2]",
            @"{'message_severity':'warning','log_item_type':'user','code':'array-contains-failed','message':'Array '' should contain at least one item that matches JSON schema.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        ...
        [InlineData("{'items': [{'const': 1}], 'additionalItems': {'const': 2}}", "[1, 3]",
            "{'message_severity':'warning','log_item_type':'user','code':'invalid-value','message':'Invalid value for '': '3'.','file':'file','line':1,'end_line':1,'column':5,'end_column':5}")]

        // required validation
        [InlineData("{'required': []}", "{}", "")]
        [InlineData("{'required': ['a']}", "{'a': 1}", "")]
        [InlineData("{'required': ['a']}", "{'b': 1}",
            "{'message_severity':'warning','log_item_type':'user','code':'missing-attribute','message':'Missing required attribute: 'a'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]

        // boolean schema
        [InlineData("true", "[]", "")]
        [InlineData("false", "[]",
            "{'message_severity':'warning','log_item_type':'user','code':'boolean-schema-failed','message':'Boolean schema validation failed for ''.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        ...
        [InlineData("{'dependencies': {'key1': ['key2']}}", "{'key1' : 1}",
            "{'message_severity':'warning','log_item_type':'user','code':'missing-paired-attribute','message':'Missing attribute: 'key2'. If you specify 'key1', you must also specify 'key2'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        ...
        [InlineData("{'properties': {'keys': {'dependencies': {'key1': ['key2']}}}}", "{'keys' : {'key1' : 1}}",
            "{'message_severity':'warning','log_item_type':'user','code':'missing-paired-attribute','message':'Missing attribute: 'key2'. If you specify 'key1', you must also specify 'key2'.','file':'file','line':1,'end_line':1,'column':11,'end_column':11}")]
        ...
        [InlineData("{'dependencies': {'key1': {'required': ['key2']}}}", "{'key1': 'a'}",
            "{'message_severity':'warning','log_item_type':'user','code':'missing-attribute','message':'Missing required attribute: 'key2'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        ...
        [InlineData("{'either': [['key1', 'key2']]}", "{}",
            "{'message_severity':'warning','log_item_type':'user','code':'missing-either-attribute','message':'One of the following attributes is required: 'key1', 'key2'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        [InlineData("{'either': [['key1', 'key2']]}", "{'key1': null}",
            "{'message_severity':'warning','log_item_type':'user','code':'missing-either-attribute','message':'One of the following attributes is required: 'key1', 'key2'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        [InlineData("{'either': [['key1', 'key2']]}", "{'key1': ''}",
            "{'message_severity':'warning','log_item_type':'user','code':'missing-either-attribute','message':'One of the following attributes is required: 'key1', 'key2'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        [InlineData("{'either': [['key1', 'key2', 'key3']]}", "{}",
            "{'message_severity':'warning','log_item_type':'user','code':'missing-either-attribute','message':'One of the following attributes is required: 'key1', 'key2', 'key3'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        [InlineData("{'either': [['key1', 'key2'], ['key3', 'key4']]}", "{}",
            @"{'message_severity':'warning','log_item_type':'user','code':'missing-either-attribute','message':'One of the following attributes is required: 'key1', 'key2'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}
              {'message_severity':'warning','log_item_type':'user','code':'missing-either-attribute','message':'One of the following attributes is required: 'key3', 'key4'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        ...
        [InlineData("{'properties': {'keys': {'either': [['key1', 'key2']]}}}", "{'keys' : {}}",
            "{'message_severity':'warning','log_item_type':'user','code':'missing-either-attribute','message':'One of the following attributes is required: 'key1', 'key2'.','file':'file','line':1,'end_line':1,'column':11,'end_column':11}")]
        ...
        [InlineData("{'precludes': [['key1', 'key2']]}", "{'key1': 1, 'key2': 2}",
            "{'message_severity':'warning','log_item_type':'user','code':'precluded-attributes','message':'Only one of the following attributes can exist: 'key1', 'key2'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        [InlineData("{'precludes': [['key1', 'key2', 'key3']]}", "{'key1': 1, 'key2': 2, 'key3': 3}",
            "{'message_severity':'warning','log_item_type':'user','code':'precluded-attributes','message':'Only one of the following attributes can exist: 'key1', 'key2', 'key3'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        [InlineData("{'precludes': [['key1', 'key2'], ['key3', 'key4']]}", "{'key1': 1, 'key2': 2, 'key3': 3, 'key4': 4}",
            @"{'message_severity':'warning','log_item_type':'user','code':'precluded-attributes','message':'Only one of the following attributes can exist: 'key1', 'key2'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}
              {'message_severity':'warning','log_item_type':'user','code':'precluded-attributes','message':'Only one of the following attributes can exist: 'key3', 'key4'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        ...
        [InlineData("{'properties': {'keys': {'precludes': [['key1', 'key2']]}}}", "{'keys' : {'key1': 1, 'key2': 2}}",
            "{'message_severity':'warning','log_item_type':'user','code':'precluded-attributes','message':'Only one of the following attributes can exist: 'key1', 'key2'.','file':'file','line':1,'end_line':1,'column':11,'end_column':11}")]
        ...
        [InlineData("{'properties': {'key1': {'dateFormat': 'M/d/yyyy'}}}", "{'key1': 'Dec 5 2018'}",
            "{'message_severity':'warning','log_item_type':'user','code':'date-format-invalid','message':'Invalid date format for 'key1': 'Dec 5 2018'.','file':'file','line':1,'end_line':1,'column':21,'end_column':21}")]
        ...
        [InlineData("{'properties': {'key1': {'dateFormat': 'M/d/yyyy', 'relativeMinDate': '-2:00:00', 'relativeMaxDate': '5:00:00:00'}}}", "{'key1': '04/26/2019'}",
            "{'message_severity':'warning','log_item_type':'user','code':'date-out-of-range','message':'Value out of range for 'key1': '04/26/2019'.','file':'file','line':1,'end_line':1,'column':21,'end_column':21}")]
        [InlineData("{'properties': {'key1': {'dateFormat': 'M/d/yyyy', 'relativeMinDate': '-2:00:00', 'relativeMaxDate': '5:00:00:00'}}}", "{'key1': '04/26/4019'}",
            "{'message_severity':'warning','log_item_type':'user','code':'date-out-of-range','message':'Value out of range for 'key1': '04/26/4019'.','file':'file','line':1,'end_line':1,'column':21,'end_column':21}")]
        ...
        [InlineData("{'properties': {'key1': {'replacedBy': ''}}}", "{'key1': 1}",
            "{'message_severity':'warning','log_item_type':'user','code':'attribute-deprecated','message':'Deprecated attribute: 'key1'.','file':'file','line':1,'end_line':1,'column':10,'end_column':10}")]
        [InlineData("{'properties': {'key1': {'replacedBy': 'key2'}}}", "{'key1': 1}",
            "{'message_severity':'warning','log_item_type':'user','code':'attribute-deprecated','message':'Deprecated attribute: 'key1', use 'key2' instead.','file':'file','line':1,'end_line':1,'column':10,'end_column':10}")]
        ...
        [InlineData("{'properties': {'key1': {'type': 'string'}, 'key2': {'type': 'string'}}, 'enumDependencies': {'key1': {'.net': {'key2': {'csharp': null, 'devlang': null}}, 'yammer': {'key2': {'tabs': null, 'vba': null}}}}}", "{'key1': 'yammer'}",
            "{'message_severity':'warning','log_item_type':'user','code':'invalid-paired-attribute','message':'Invalid value for 'key2': 'key2' is not valid with 'key1' value 'yammer'.','file':'file','line':1,'end_line':1,'column':1,'end_column':1}")]
        ...
        [InlineData("{'properties': {'key1': {'type': 'string'}, 'key2': {'type': 'string'}}, 'enumDependencies': {'key1': {'.net': {'key2': {'csharp': null, 'devlang': null}}, 'yammer': {'key2': {'tabs': null, 'vba': null}}}}}", "{'key1': 'yyy', 'key2': 'tabs'}",
            "{'message_severity':'warning','log_item_type':'user','code':'invalid-value','message':'Invalid value for 'key1': 'yyy'.','file':'file','line':1,'end_line':1,'column':14,'end_column':14}")]
        ...
        [InlineData("{'properties': {'key1': {'type': 'string'}, 'key2': {'type': 'string'}}, 'enumDependencies': {'key1': {'.net': {'key2': {'csharp': null, 'devlang': null}}, 'yammer': {'key2': {'tabs': null, 'vba': null}}}}}", "{'key1': 'yammer', 'key2': 'abc'}",
            "{'message_severity':'warning','log_item_type':'user','code':'invalid-paired-attribute','message':'Invalid value for 'key2': 'abc' is not valid with 'key1' value 'yammer'.','file':'file','line':1,'end_line':1,'column':32,'end_column':32}")]
        ...
        [InlineData("{'properties': {'key1': {'type': 'array', 'items': {'type': 'string'}}}, 'enumDependencies': {'key1[0]': {'.net': {'key1[1]': {'csharp': null, 'devlang': null}}, 'yammer': {'key1[1]': {'tabs': null, 'vba': null}}}}}", "{'key1': ['yammer','abc']}",
            "{'message_severity':'warning','log_item_type':'user','code':'invalid-paired-attribute','message':'Invalid value for 'key1[1]': 'abc' is not valid with 'key1[0]' value 'yammer'.','file':'file','line':1,'end_line':1,'column':24,'end_column':24}")]
        ...
        [InlineData("{'properties': {'key1': {'type': 'array', 'items': {'type': 'string'}}}, 'enumDependencies': {'key1[0]': {'.net': {'key1[1]': {'csharp': null, 'devlang': null}}, 'yammer': {'key1[1]': {'tabs': {'key1[2]': {'vst': null, 'yiu': null}}, 'vba': null}}}}}", "{'key1': ['yammer','tabs','abc']}",
            "{'message_severity':'warning','log_item_type':'user','code':'invalid-paired-attribute','message':'Invalid value for 'key1[2]': 'abc' is not valid with 'key1[1]' value 'tabs'.','file':'file','line':1,'end_line':1,'column':31,'end_column':31}")]
        ...
        [InlineData("{'required': ['author'], 'customRules': {'author': {'missing-attribute': {'severity': 'suggestion', 'code': 'author-missing', 'additionalMessage': 'Add a valid GitHub ID.', 'pullRequestOnly': true}}}}", "{'b': 1}",
            "{'message_severity':'suggestion','log_item_type':'user','code':'author-missing','message':'Missing required attribute: 'author'. Add a valid GitHub ID.','file':'file','line':1,'end_line':1,'column':1,'end_column':1,'pr_only':true}")]
