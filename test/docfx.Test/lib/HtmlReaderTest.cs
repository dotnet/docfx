...
namespace Microsoft.Docs.Build
{
    public class HtmlReaderTest
    {
        ...
        [InlineData("<a/ >", "StartTag:a")]
        [InlineData("<a / >", "StartTag:a")]
        [InlineData("<abc def name='s' key=\"v\" />", "StartTag:abc(def:, name:s, key:v)")]
        [InlineData("<a/b>", "StartTag:a(b:)")]
        ...
        // Attributes
        [InlineData("<a b=c>", "StartTag:a(b:c)")]
        [InlineData("<a href='single quote'>", "StartTag:a(href:single quote)")]
        [InlineData("<a href=\"double quote\">", "StartTag:a(href:double quote)")]
        [InlineData("<a href=noquote>", "StartTag:a(href:noquote)")]
        [InlineData("<a data-bool>", "StartTag:a(data-bool:)")]
        [InlineData("<a =b>", "StartTag:a(=b:)")]
        [InlineData("<a  b= c>", "StartTag:a(b:c)")]
        [InlineData("<asdf b = cdef f  >", "StartTag:asdf(b:cdef, f:)")]
        [InlineData("<a b =c/>", "StartTag:a(b:c/)")]
        [InlineData("<a b =c />", "StartTag:a(b:c)")]
        [InlineData("<a b =c / />", "StartTag:a(b:c)")]
        [InlineData("<a b =c < />", "StartTag:a(b:c, <:)")]
        ...
        [InlineData("<a b =< />", "StartTag:a(b:<)")]
        [InlineData("<a < = b />", "StartTag:a(<:b)")]
        [InlineData("<a b/c=d />", "StartTag:a(b:, c:d)")]
        [InlineData("<a b=>", "StartTag:a(b:)")]
        ...
        [InlineData("<a b='cd>'></a>", "StartTag:a(b:cd>), EndTag:a")]
        ...
        [InlineData("<div id=\"foo\"class=\"bar\">", "StartTag:div(id:foo, class:bar)")]
        ...
        [InlineData("<div foo<div>", "StartTag:div(foo<div:)")]
        [InlineData("<div id'bar'>", "StartTag:div(id'bar':)")]
        [InlineData("<div foo=b'ar'>", "StartTag:div(foo:b'ar')")]
        [InlineData("<div foo=\"bar\" =\"baz\">", "StartTag:div(foo:bar, =\"baz\":)")]
        [InlineData("<?xml-stylesheet type=\"text/css\" href=\"style.css\"?>", "Comment:<?xml-stylesheet type=\"text/css\" href=\"style.css\"?>")]
        [InlineData("<div / id=\"foo\">", "StartTag:div(id:foo)")]
