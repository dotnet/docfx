...
namespace Microsoft.Docs
{
    public class GlobMatcherTest
    {
        ...
        public void NegateGlobShouldAllowMultipleNegateChars(string pattern, bool expectedNegate, string expected)
        {
        ...
        public void GroupedGlobShouldExpand(string source, string[] expected)
        {
