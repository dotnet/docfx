...
namespace Microsoft.Docs.Build
{
  ...
  ""d"": true
        ...
        {
            var (errors, value) = JsonUtility.Deserialize<BasicClass>("{\"B\":1}");
            ...
            var json = @"
{
  ...
  ""d"": true
        ...
        {
            var targetJson = JsonUtility.DeserializeData<JObject>(target);
            var sourceJson = JsonUtility.DeserializeData<JObject>(source);
...
""valueRequired"": ""a""
        ...
        {
            var exception = Assert.Throws<DocfxException>(() => JsonUtility.DeserializeData<BasicClass>(json.Replace('\'', '\"')));
