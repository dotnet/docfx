...
namespace Microsoft.Docs.Build
{
    public static class ConfigTest
    {
        ...
        public static void LocConfigConventionRepoRemote(LocalizationMapping locMappingType, string sourceName, string locale, string locName)
            => Assert.Equal(locName, LocalizationConvention.GetLocalizationRepo(new LocalizationConfig(locMappingType), sourceName, "master", locale, "en-us").remote);
        ...
        public static void LocConfigConventionRepoBranch(LocalizationMapping locMappingType, bool enableBilingual, string sourceBranch, string locale, string targetBranch)
            => Assert.Equal(targetBranch, LocalizationConvention.GetLocalizationRepo(new LocalizationConfig(locMappingType, enableBilingual), "abc", sourceBranch, locale, "en-us").branch);
    }
}
