...
namespace Microsoft.Docs.Build
{
    public static class TocTest
    {
        ...
        private static readonly TemplateEngine s_templateEngine = new TemplateEngine(s_docsetPath, s_config, "en-us", new PackageResolver(s_docsetPath, s_config));
        private static readonly BuildScope s_buildScope = new BuildScope(s_config, s_input, null);
        private static readonly DocumentProvider s_documentProvider = new DocumentProvider(s_config, s_docset, null, s_buildScope, s_input, s_repositoryProvider, s_templateEngine);
