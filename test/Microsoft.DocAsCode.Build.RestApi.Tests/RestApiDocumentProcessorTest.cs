...
namespace Microsoft.DocAsCode.Build.RestApi.Tests
{
    ...
    public class RestApiDocumentProcessorTest : TestBase
    {
        ...
        public void ProcessSwaggerWithXRefMap()
        {
            ...
            Assert.Equal("contacts.json#graph_windows_net_myorganization_Contacts_1_0", rootItem.Href);
            ...
            Assert.Equal("contacts.json#graph_windows_net_myorganization_Contacts_1_0_delete_contact", childItem1.Href);
        }
