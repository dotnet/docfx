...
";
            ...
            Assert.Equal(19, output.References.Count);
            {
                ...
                Assert.Equal("System.Object", string.Concat(item.QualifiedNameParts[SyntaxLanguage.CSharp].Select(p => p.DisplayName)));
            }
            {
