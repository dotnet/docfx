...
")]
        [InlineData(@":::code source=""source.cs"" range=""1-2"" highlight=""6-7"" language=""azurecli"" interactive=""try-dotnet"":::", @"<pre>
<code class=""lang-azurecli"" data-interactive=""azurecli"" data-interactive-mode=""try-dotnet"" highlight-lines=""6-7"">
using System;
...
")]
        public void CodeTestBlockGeneralCSharp(string source, string expected)
        {
