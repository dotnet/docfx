...
")]
        ...
        //[InlineData(@":::code source=""source.cs"" id=""Snippet_Table_Columns_Manip"" highlight=""6-7"" language=""azurecli"" interactive=""try-dotnet"":::", "pass")]
        //[InlineData(@":::code source=""source.cs"" id=""Snippet_Table_Columns_Manip"" highlight=""6-7"" interactive=""try-dotnet"":::", "pass")]
        //[InlineData(@":::code source=""BADSOURCE.cs"" id=""Snippet_Table_Columns_Manip"" highlight=""6-7"" interactive=""try-dotnet"":::", "pass")]
...
#region Snippet_Table_Columns_Manip
        ...
        void TableCellConst()
        {
            ...
            File.WriteAllText("source.cs", content.Replace("\r\n", "\n"));
