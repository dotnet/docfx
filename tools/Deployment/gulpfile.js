...
gulp.task("test", gulp.series("clean", "build", "pack", "e2eTest", "publish:myget-test"));
gulp.task("dev", gulp.series("clean", "build", "pack", "e2eTest"));
gulp.task("dev:build", gulp.series("clean", "build"));
gulp.task("dev:release", gulp.series("pack", "e2eTest", "publish:myget-dev", "publish:azdevops-perf-login", "publish:azdevops-perf", "publish:azdevops-internal-login", "publish:azdevops-internal", "publish:azdevops-ppe-login", "publish:azdevops-ppe"));
