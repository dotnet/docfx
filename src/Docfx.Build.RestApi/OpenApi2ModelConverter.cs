...
internal static class OpenApi2ModelConverter
{
    internal static RestApiRootItemViewModel ConvertLegacy(SwaggerModel swagger)
    {
    ...
    {
        var model = ConvertLegacy(swagger);
