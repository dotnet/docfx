...
namespace Microsoft.Extensions.ProjectModel
{
    public class ProjectReader
    {
        ...
        public Project ReadProject(Stream stream, string projectName, string projectPath, ICollection<DiagnosticMessage> diagnostics)
        {
            ...
            project.Authors = rawProject.ValueAsStringArray("authors") ?? new string[0];
            project.Owners = rawProject.ValueAsStringArray("owners") ?? new string[0];
            project.Tags = rawProject.ValueAsStringArray("tags") ?? new string[0];
