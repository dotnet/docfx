...
partial class SymbolUrlResolver
{
    ...
    private static ReadOnlySpan<byte> CSharpLangwords =>
        """
        {
          ...
          "as": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/type-testing-and-cast#as-operator",
          ...
          "case": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/selection-statements#the-switch-statement",
          "catch": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/try-catch",
          ...
          "delegate": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/reference-types",
          "do": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/iteration-statements#the-do-statement",
          "double": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/floating-point-numeric-types",
          "else": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/selection-statements#the-if-statement",
          ...
          "explicit": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/user-defined-conversion-operators",
          "extern": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/extern",
          "false": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/bool",
          "finally": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/try-finally",
          ...
          "if": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/selection-statements#the-if-statement",
          "implicit": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/user-defined-conversion-operators",
          ...
          "is": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/is",
          ...
          "new": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/new-operator",
          ...
          "operator": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/operator-overloading",
          ...
          "params": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/params",
          ...
          "sizeof": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/sizeof",
          ...
          "switch": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/switch-expression",
          ...
          "true": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/bool",
          "try": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/try-catch",
          "typeof": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/type-testing-and-cast#typeof-operator",
          ...
          "using": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/using",
          ...
          "and": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/patterns#logical-patterns",
          "alias": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/extern-alias",
          "ascending": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/ascending",
          "args": "https://learn.microsoft.com/en-us/dotnet/csharp/fundamentals/program-structure/top-level-statements#args",
          ...
          "from": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/from-clause",
          "get": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/get",
          "global": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/namespace-alias-qualifier",
          "group": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/group-clause",
          ...
          "join": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/join-clause",
          "let": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/let-clause",
          "managed": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/unsafe-code#function-pointers",
          "nameof": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/nameof",
          "nint": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/integral-numeric-types",
          "not": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/patterns#logical-patterns",
          "notnull": "https://learn.microsoft.com/en-us/dotnet/csharp/programming-guide/generics/constraints-on-type-parameters#notnull-constraint",
          "nuint": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/builtin-types/integral-numeric-types",
          "on": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/on",
          "or": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/patterns#logical-patterns",
          "orderby": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/orderby-clause",
          "partial": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/partial-method",
          ...
          "scoped": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/statements/declarations#scoped-ref",
          "select": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/select-clause",
          "set": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/set",
          "unmanaged": "https://learn.microsoft.com/en-us/dotnet/csharp/programming-guide/generics/constraints-on-type-parameters#unmanaged-constraint",
          "value": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/value",
          ...
          "where": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/keywords/where-clause",
          "with": "https://learn.microsoft.com/en-us/dotnet/csharp/language-reference/operators/with-expression",
