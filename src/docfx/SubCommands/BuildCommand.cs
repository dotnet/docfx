...
namespace Microsoft.DocAsCode.SubCommands
{
    ...
    internal sealed class BuildCommand : ISubCommand
    {
        ...
        {
            EnvironmentContext.SetBaseDirectory(string.IsNullOrEmpty(Config.BaseDirectory) ? Directory.GetCurrentDirectory() : Config.BaseDirectory);
            ...
            var outputFolder = Path.Combine(string.IsNullOrEmpty(Config.OutputFolder) ? baseDirectory : Config.OutputFolder, Config.Destination ?? string.Empty);
