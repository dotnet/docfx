...
namespace Microsoft.Docs.Build
{
    ...
    internal static class JsonUtility
    {
        ...
        [ThreadStatic]
        private static Func<DataTypeAttribute, object, string, string, object> t_transform;
        ...
        public static (List<Error>, object) ToObject(
            JToken token,
            Type type,
            Func<DataTypeAttribute, object, string, string, object> transform = null)
        {
        ...
        private sealed class SchemaValidationAndTransformConverter : JsonConverter
        {
            ...
            public override object ReadJson(JsonReader reader, Type objectType, object existingValue, JsonSerializer serializer)
            {
                ...
                return t_transform != null ? t_transform(_attribute, value, reader.Path, _fieldName) : value;
            }
        }
    }
}
