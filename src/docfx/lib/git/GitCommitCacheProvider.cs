...
namespace Microsoft.Docs.Build
{
    internal static class GitCommitCacheProvider
    {
        ...
        public static Task SaveCache(string repoRemote, ConcurrentDictionary<string, Dictionary<(long commit, long blob), (long[] commitHistory, int lruOrder)>> commitCache)
        {
