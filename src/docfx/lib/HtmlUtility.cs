...
namespace Microsoft.Docs.Build
{
    internal static class HtmlUtility
    {
        ...
        // todo remove `class` & `hidden` after we can know it is is generated by ourself
        private static readonly string[] s_globalAllowedAttributes = new[] { "id", "itemid", "itemprop", "itemref", "itemscope", "itemtype", "part", "slot", "spellcheck", "title", "role", "class", "hidden" };
        ...
        private static readonly Dictionary<string, string[]> s_allowedTagAtrributeMap = new Dictionary<string, string>()
        {
            ...
            { "image", "alt, decoding, height, intrinsicsize, loading, sizes, src, width" },
        ...
        internal static List<Error> SecurityScan(this HtmlNode html, Document file)
        {
            ...
            foreach (var node in html.DescendantsAndSelf())
            {
                ...
                // ignore herf. will implement in another feature. todo
                if (node.Name == "a")
                {
                    continue;
                }
