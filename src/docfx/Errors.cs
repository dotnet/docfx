    ...
    internal static class Errors
    {
        ...
        public static class Content
        {
            ...
            public static Error DisallowedHTMLTag(Document file, string tag)
                => new Error(ErrorLevel.Info, "disallowed-html", $"HTML tag '{tag}' isn't allowed. Disallowed HTML poses a security risk and must be replaced with approved Docs Markdown syntax.", file.FilePath);
            ...
            public static Error DisallowedHTMLAttribute(Document file, string tag, string attribute)
                => new Error(ErrorLevel.Info, "disallowed-html", $"HTML attribute '{attribute}' on tag '{tag}' isn't allowed. Disallowed HTML poses a security risk and must be replaced with approved Docs Markdown syntax.", file.FilePath);
        }
    }
}
