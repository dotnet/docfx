...
namespace Microsoft.Docs.Build
{
    internal static class Errors
    {
        ...
        public static Error GitBranchNotFound(string branch)
            => new Error(ErrorLevel.Error, "git-branch-not-found", $"Cannot find {branch} branch either from local or remote");
