...
namespace Microsoft.Docs.Build
{
    internal static class Errors
    {
        ...
        public static Error BookmarkNotFound(string book, string href, Document relativeTo)
            => new Error(ErrorLevel.Warning, "bookmark-not-found", $"Cannot find bookmark '{book}' in '{href}' relative to {relativeTo}");
