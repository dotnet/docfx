...
namespace Microsoft.Docs.Build
{
    internal static class Errors
    {
        ...
        public static Error DependenyRepoNotFound(string dependenyRepoHref)
            => new Error(ErrorLevel.Error, "dependency-repo-not-found", $"The dependency repository with href '{dependenyRepoHref}' is not found, make sure to run the `store` command");
