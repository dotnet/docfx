...
namespace Microsoft.Docs.Build
{
    internal static class Errors
    {
        ...
        /// </summary>
        public static Error ExceedMaxErrors(int maxErrors, string type)
            => new Error(ErrorLevel.Error, "exceed-max-errors", $"{type} count exceed '{maxErrors}'. Build will continue but newer {type} logs will be ignored.");
