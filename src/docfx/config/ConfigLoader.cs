...
namespace Microsoft.Docs.Build
{
    internal static class ConfigLoader
    {
        ...
        /// </summary>
        public static (Config, BuildOptions, PackageResolver, FileResolver, OpsInterceptor) Load(
            ErrorBuilder errors, DisposableCollector disposables, string docsetPath, string? outputPath, CommandLineOptions options, FetchOptions fetchOptions)
        {
            ...
            var opsInterceptor = new OpsInterceptor(errors, credentialProvider);
            var configAdapter = new OpsConfigAdapter(opsInterceptor);
            ...
            return (config, buildOptions, packageResolver, fileResolver, opsInterceptor);
        }
