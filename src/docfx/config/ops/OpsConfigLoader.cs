...
namespace Microsoft.Docs.Build
{
    internal static class OpsConfigLoader
    {
        ...
        public static (string xrefEndpoint, string[] xrefQueryTags, string locale, JObject config) LoadDocfxConfig(string docsetPath, string branch)
        {
        ...
        private static (string xrefEndpoint, string[] xrefQueryTags, string locale, JObject config) ToDocfxConfig(string branch, OpsConfig opsConfig, PathString buildSourceFolder)
        {
