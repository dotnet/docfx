...
namespace Microsoft.Docs.Build
{
    internal class Config : PreloadConfig
    {
        ...
        /// </summary>
        public string XrefHostName { get; } = string.Empty;
        ...
        /// </summary>
        public ContributionConfig Contribution { get; } = new ContributionConfig();
        ...
        /// </summary>
        public GitHubConfig GitHub { get; } = new GitHubConfig();

        /// <summary>
        /// Gets the configurations related to Microsoft Graph.
        /// </summary>
        public MicrosoftGraphConfig MicrosoftGraph { get; } = new MicrosoftGraphConfig();
        ...
        /// </summary>
        [JsonConverter(typeof(OneOrManyConverter))]
        public SourceInfo<string>[] Xref { get; } = Array.Empty<SourceInfo<string>>();
        ...
        /// </summary>
        public SourceInfo<string> MonikerDefinition { get; } = new SourceInfo<string>(string.Empty);

        /// <summary>
        /// Get the file path of content validation rules
        /// </summary>
        public SourceInfo<string> MarkdownValidationRules { get; } = new SourceInfo<string>(string.Empty);

        /// <summary>
        /// Get the metadata JSON schema file path.
        /// </summary>
        [JsonConverter(typeof(OneOrManyConverter))]
        public SourceInfo<string>[] MetadataSchema { get; } = Array.Empty<SourceInfo<string>>();

        /// <summary>
        /// Get the template folder or git repository url (like https://github.com/docs/theme#master)
        /// </summary>
        public PackagePath Template { get; } = new PackagePath();

        /// <summary>
        /// When enabled, updated_at for each document will be the last build time
        /// for the latest commit that touches that document.
        /// </summary>
        public bool UpdateTimeAsCommitBuildTime { get; } = false;

        /// <summary>
        /// When enabled, update the state of commit build time for this build.
        /// </summary>
        public bool UpdateCommitBuildTime { get; } = true;
