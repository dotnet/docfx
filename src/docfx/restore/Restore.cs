        ...
        public static async Task Run(string docsetPath, CommandLineOptions options, Report report)
        {
                ...
                bool root)
            {
                ...
                await ParallelUtility.ForEach(
                    config.Extend.Where(LinkUtility.IsHttp),
                ...
                if (LinkUtility.IsHttp(extendedConfig.DependencyLock))
                ...
                var restoreUrls = extendedConfig.GetFileReferences().Where(LinkUtility.IsHttp).ToList();
