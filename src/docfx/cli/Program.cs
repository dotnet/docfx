    ...
    internal static class Program
    {
        ...
        private static (string command, string docset, CommandLineOptions options) ParseCommandLineOptions(string[] args)
        {
            ...
            ArgumentSyntax.Parse(args, syntax =>
            {
                ...
                syntax.DefineOption("repo", ref options.Legacy, "Overrides the current git repo name guessed from remote URL.");
                syntax.DefineOption("branch", ref options.Legacy, "Overrides the current git branch name guessed.");
                syntax.DefineParameter("docset", ref docset, "Docset directory that contains docfx.yml.");
            });
