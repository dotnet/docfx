...
internal class TemplateEngine
{
    ...
    public (TemplateModel model, JObject metadata) CreateTemplateModel(FilePath file, string? mime, JObject pageModel)
    {
        ...
        templateMetadata["canonical_url"] = pageModel["canonical_url"] ?? pageModel["metadata"]?["canonical_url"];
        templateMetadata["_op_canonicalUrl"] = pageModel["_op_canonicalUrl"] ?? pageModel["metadata"]?["_op_canonicalUrl"];
