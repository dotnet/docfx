...
namespace Microsoft.Docs.Build
{
    ...
    internal sealed class Context : IDisposable
    {
        ...
        public readonly XrefMapProvider XrefMapProvider;
        ...
        public Context(string outputPath, ErrorLog errorLog,  Docset docset)
        {
            ErrorLog = errorLog;
            ...
            XrefMapProvider = new XrefMapProvider();
            DependencyMapBuilder = new DependencyMapBuilder();
            DependencyResolver = new DependencyResolver(BuildQueue, GitCommitProvider, BookmarkValidator, DependencyMapBuilder, new Lazy<XrefMapProvider>(() => XrefMapProvider));
