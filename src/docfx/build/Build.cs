    ...
    internal static class Build
    {
            ...
            ErrorBuilder errors, string workingDirectory, string docsetPath, string? outputPath, CommandLineOptions options)
        {
            ...
            try
            {
                ...
                var (config, buildOptions, packageResolver, fileResolver, configAdapter) = ConfigLoader.Load(
                ...
                new OpsPostProcessor(config, errors, buildOptions, (request) => configAdapter.InterceptHttpRequest(request)).Run();
            }
