...
namespace Microsoft.Docs.Build
{
    internal static class LegacyUtility
    {
        ...
        {
            return PathUtility.NormalizeFile(Path.GetRelativePath(docset.Config.LegacyConfig.SourceBasePath, doc.FilePath));
        }
        ...
        public static string ToLegacyOutputPathRelativeToBaseSitePath(this Document doc, Docset docset)
        {
            ...
            if (legacyOutputFilePathRelativeToSiteBasePath.StartsWith(docset.Config.LegacyConfig.SiteBasePath, PathUtility.PathComparison))
            {
                legacyOutputFilePathRelativeToSiteBasePath = Path.GetRelativePath(docset.Config.LegacyConfig.SiteBasePath, legacyOutputFilePathRelativeToSiteBasePath);
            }
        ...
        public static string ToLegacySiteUrlRelativeToBaseSitePath(this Document doc, Docset docset)
        {
            ...
            if (legacySiteUrlRelativeToSiteBasePath.StartsWith($"/{docset.Config.LegacyConfig.SiteBasePath}", PathUtility.PathComparison))
            {
                legacySiteUrlRelativeToSiteBasePath = Path.GetRelativePath(docset.Config.LegacyConfig.SiteBasePath, legacySiteUrlRelativeToSiteBasePath.Substring(1));
            }
        ...
        {
            return Path.Combine(docset.Config.LegacyConfig.SiteBasePath, legacyManifestOutputItem.OutputPathRelativeToSiteBasePath);
        }
