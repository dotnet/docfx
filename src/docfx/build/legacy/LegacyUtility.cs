...
namespace Microsoft.Docs.Build
{
    internal static class LegacyUtility
    {
        ...
        public static string ToLegacySiteUrlRelativeToBasePath(this Document doc, Context context)
        {
            ...
            if (!context.Config.StaticOutput && Path.GetFileNameWithoutExtension(doc.FilePath.Path).Equals("index", PathUtility.PathComparison) && doc.ContentType != ContentType.Resource)
            {
