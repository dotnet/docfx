                    ...
                    fileManifest =>
                    {
                        ...
                        var output = new LegacyManifestOutput
                        {
                            ...
                            : new LegacyManifestOutputItem
                            {
                                ...
                                : PathUtility.ChangeExtension(legacyOutputPathRelativeToSiteBasePath, ".mta.json"),
                            },
                        };
                            ...
                            document.ContentType == ContentType.Redirection)
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    IsRawPage = false,
                                    RelativePath = PathUtility.ChangeExtension(legacyOutputPathRelativeToSiteBasePath, ".raw.page.json"),
                                };
                            }
                        }
