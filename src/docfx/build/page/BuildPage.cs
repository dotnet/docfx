...
namespace Microsoft.Docs.Build
{
    internal static class BuildPage
    {
        ...
        private static SystemMetadata CreateSystemMetadata(ErrorBuilder errors, Context context, FilePath file, UserMetadata userMetadata)
        {
            ...
            (systemMetadata.ContributionInfo, systemMetadata.GitContributorInformation) =
                context.ContributionProvider.GetContributionInfo(errors, file, userMetadata.Author);
