    ...
    internal class DocsetBuilder
    {
        ...
        public void Build(params string[] files)
        {
            try
            {
                ...
                var redirectionProvider = new RedirectionProvider(_buildOptions.DocsetPath, _config.HostName, _errors, _buildScope, _buildOptions.Repository, _documentProvider, _monikerProvider, new Lazy<PublishUrlMap>(() => publishUrlMap!), _config);
