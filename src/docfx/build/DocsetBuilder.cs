    ...
    internal class DocsetBuilder
    {
        ...
        public void Build(params string[] files)
        {
            try
            {
                ...
                var redirectionProvider = new RedirectionProvider(_config, _buildOptions, _config.HostName, _errors, _buildScope, _documentProvider, _monikerProvider, new Lazy<PublishUrlMap>(() => publishUrlMap!));
