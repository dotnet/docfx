...
namespace Microsoft.Docs.Build
{
    internal class Document
    {
        ...
        {
            var sourcePath = PathUtility.NormalizeFile(Path.GetRelativePath(Docset.Config.LegacyConfig.SourceBasePath, FilePath));
            ...
            var sitePath = PathUtility.NormalizeFile(Path.GetRelativePath(Docset.Config.LegacyConfig.SiteBasePath, sitePathWithoutExtension));
